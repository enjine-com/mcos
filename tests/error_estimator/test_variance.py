...
from mcos.error_estimator import VarianceErrorEstimator

class TestVarianceErrorEstimator:
    ...
    def test_estimate(self, prices_df):
        ...
        estimation = VarianceErrorEstimator().estimate(mu, cov, allocation, optimal_allocation)

        assert_almost_equal(estimation, 0.0044184)
